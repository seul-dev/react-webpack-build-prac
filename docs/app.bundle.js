...
var Form = function Form(_ref) {
  var addDiscussion = _ref.addDiscussion;
  ...
  var handleSubmit = function handleSubmit(event) {
    ...
    var bodyText = event.target[2].value;
    addDiscussion({
      author: author,
      title: title,
      bodyText: bodyText
...
;// CONCATENATED MODULE: ./src/components/Discussion.js



var Discussion = function Discussion(_ref) {
  var discussion = _ref.discussion,
      deleteDiscussion = _ref.deleteDiscussion;
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("li", {
    ...
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)("h2", {
        ...
        children: "".concat(author, " / ").concat(new Date(createdAt).toLocaleTimeString())
      })]
    }), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
      className: "discussion__answered",
...
;// CONCATENATED MODULE: ./src/components/Discussions.js



var Discussions = function Discussions(_ref) {
  var discussions = _ref.discussions,
      deleteDiscussion = _ref.deleteDiscussion;
  return /*#__PURE__*/(0,jsx_runtime.jsx)("section", {
    className: "discussion__wrapper",
    children: /*#__PURE__*/(0,jsx_runtime.jsx)("ul", {
      className: "discussions__container",
      children: discussions.map(function (discussion) {
        return /*#__PURE__*/(0,jsx_runtime.jsx)(Discussion, {
...
function App() {
  ...
  var _useState = (0,react.useState)([]),
      ...
      discussions = _useState2[0],
      setDiscussions = _useState2[1];

  (0,react.useEffect)(function () {
    getDiscussion();
  }, []);

  var getDiscussion = function getDiscussion() {
    return fetch(domain + '/discussions').then(function (res) {
      return res.json();
    }).then(function (data) {
      setDiscussions(data);
    });
  ...
  var addDiscussion = function addDiscussion(_ref) {
  ...
  var deleteDiscussion = function deleteDiscussion(id) {
    fetch(domain + "/discussions/".concat(id), {
      method: 'DELETE'
    }).then(function (res) {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)("h1", {
      children: "My Agora States!!!"
    }), /*#__PURE__*/(0,jsx_runtime.jsx)(Form, {
      addDiscussion: addDiscussion
    }), /*#__PURE__*/(0,jsx_runtime.jsx)(Discussions, {
